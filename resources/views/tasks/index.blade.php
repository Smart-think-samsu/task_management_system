                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="text-right">
                                <a type="button" href="{{Route('tasks.create')}}" class="btn btn-primary">
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                @foreach($tasks as $key => $task)
                                    <tr>
                                        ...
                                        <td>{{$task->completion_at}}</td>
                                        <td>
                                            {{
                                                $task->is_completed === 0 ? "Pending" :
                                                ($task->is_completed === 1 ? "Progress" :
                                                ($task->is_completed === 2 ? "Completed" : "Null"))
                                            }}
                                        </td>
                                        <td class="project-actions">
                                            <a type="button" class="btn btn-sm btn-info" href="{{ route('tasks.edit', $task->id) }}">
